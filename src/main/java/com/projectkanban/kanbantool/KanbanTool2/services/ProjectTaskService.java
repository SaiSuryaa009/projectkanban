package com.projectkanban.kanbantool.KanbanTool2.services;
...
import com.projectkanban.kanbantool.KanbanTool2.exceptions.ProjectNotFoundException;
import com.projectkanban.kanbantool.KanbanTool2.repositories.BacklogRepository;
import com.projectkanban.kanbantool.KanbanTool2.repositories.ProjectRepository;
...
public class ProjectTaskService {
	...
	public ProjectTask addProjectTask(String projectIdentifier, ProjectTask projectTask, String username) {
			...
			//ProjectTaks to be added to a specific project, project != null, BackLog exists
			...
			//Add Sequence to Project Task like IDPR-1,IDPR-2 
